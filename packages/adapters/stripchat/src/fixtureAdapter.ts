...
export const STRIPCHAT_ADAPTER_ID = "stripchat";

export const STRIPCHAT_FIXTURE_CAPABILITIES = [
  "fixture.timeline",
  "media.discovery",
  "room.state",
  "diagnostics"
...
export interface StripchatSyntheticFixture {
  readonly name: string;
  readonly sessionId: string;
  readonly events: readonly TimelineEventEnvelope[];
}

export async function* runStripchatFixture(
  fixture: StripchatSyntheticFixture
